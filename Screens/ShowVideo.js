...
// import video-thumbnail from '../assets/video-thumbnail.png';import { style } from '../Style/style';
...
const [isVideoVisible, setIsVideoVisible] = useState(false);
  ...
  useEffect(() => {
    const fetchVideo = async () => {
      ...
      // let id=resp.id;  
      // console.log(id)
      console.log("The Id is below down = ")
      console.log(id)
      const {id}=route.params;
      console.log("Id is Below Down = ")
      console.log(id)
...
const t=flag;
  ...
  return (
    <ImageBackground
    source={require('../assets/planes.png')} // Replace with the path to your image
...
{/* <View style={{marginTop:680}}>
<Button title='press  It '  />
</View> */}
<TouchableOpacity  style={style.vidBtnBack}>
<View style={[style.ArrowCont, { flexDirection: 'row', alignItems: 'center' } ]  } >
